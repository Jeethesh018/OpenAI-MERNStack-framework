            ...
            images.length > 0 ? (
              <div className='flex flex-wrap max-sm:justify-center gap-5'>
                 {images.map((item,index)=>(
                  ...
                  border-gray-200 dark:border-purple-700 shadow-sm hover:shadow-md transition-shadow
                  duration-300'>
                    <img src={item.imageUrl} className='w-full h-40 md:h-50 2xl:h-62
                    ...
                    group-hover:opacity-100 transition duration-300'>Created bt {item.userName}</p>
                  </a>
                 ))}   
                </div>
            ):(
