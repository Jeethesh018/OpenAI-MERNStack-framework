...
const Sidebar = () => {
 ...
 const [search,setSearch] = useState("")
  ...
  return (
    <div className='flrx flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#80609f]/30  backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-1 '>
          ...
          chat.name.toLowerCase().includes(search.toLowerCase())).map((chat)=> (
            ...
            rounded-md cursor-pointer flex justify-between group'>
               <div>
                ...
                <p className='text-sx text-gray-500 dark:text-[#B1A6CO]]'>{chat.updatedAt}</p>
                </div>
              </div>
          ))
         }
